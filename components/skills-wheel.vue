        ...
        <g fill="none" fill-rule="evenodd">
            ...
            <g id="master">
                ...
                <g class="group" transform="translate(137 541)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="6" y="-3px">HTML</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                ...
                <g class="group" transform="translate(300 138)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="-7" y="-3px">AdobeXD</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                    <g id="AdobeXD" transform="scale(0.14) translate(60, 60)" >
                        <g>
                            <g>
                                <g>
                                    <path fill="#070302" class="st0" d="M42.5,0h155C221,0,240,19,240,42.5v149c0,23.5-19,42.5-42.5,42.5h-155C19,234,0,215,0,191.5v-149
                                        C0,19,19,0,42.5,0z"/>
                                </g>
                            </g>
                        </g>
                        <g>
                            <g>
                                <path fill="#fff" class="st1" d="M126.2,61.5L96.2,111l32,52.5c0.2,0.4,0.3,0.8,0.2,1.2c-0.1,0.4-0.5,0.1-1.1,0.2h-22.9
                                ...
                                <path fill="#fff" class="st1" d="M172.4,167c-7.4,0.1-14.8-1.4-21.5-4.5c-6.3-2.9-11.5-7.7-15.1-13.6c-3.7-6.1-5.5-13.7-5.5-22.8
                ...
                <g class="group" transform="translate(87 98)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="-13" y="-3px">Procreate</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                    <g id="Procreate" transform="scale(0.9) translate(4, 3)" >
                        <path fill="#070302" d="M38,42H10c-2.209,0-4-1.791-4-4V10c0-2.209,1.791-4,4-4h28c2.209,0,4,1.791,4,4v28	C42,40.209,40.209,42,38,42z"/><path fill="#fff" d="M36.88,18.02c-0.64,1.6-1.63,3.24-3.11,4.77c-0.02,0.02-0.04,0.05-0.06,0.07	c-1.52,1.55-3.54,2.99-6.21,4.14c-0.27,0.12-0.53,0.22-0.79,0.33c-0.94,0.38-1.82,0.7-2.66,0.97c-7.04,2.28-10.87,1.47-13.88,9.26	C10.11,37.7,10.06,37.85,10,38c0-0.19,0-0.38,0.01-0.57C10.08,33.14,11.18,24.11,24.5,21c1.17-0.28,2.24-0.59,3.21-0.93	C36.49,17,37.5,11.55,37.5,9.75C38.02,11.29,38.27,14.56,36.88,18.02z"/><path fill="#fff" d="M33.77,22.79c-0.02,0.02-0.04,0.05-0.06,0.07c-1.52,1.55-3.54,2.99-6.21,4.14	c-0.27,0.12-0.53,0.22-0.79,0.33c-0.94,0.38-1.82,0.7-2.66,0.97c-7.04,2.28-10.87,1.47-13.88,9.26C10.11,37.7,10.06,37.85,10,38	c0.02-0.16,0.04-0.33,0.07-0.52c0.04-0.27,0.09-0.57,0.16-0.89c0-0.01,0-0.03,0.01-0.05C10.81,33.63,12.38,29.1,17,27	C19.8,25.73,27.99,23.64,33.77,22.79z"/><path fill="#fff" d="M24.05,28.3C17.01,30.58,13.01,30.21,10,38l0.07-0.52l-0.06-0.05c0.07-0.26,0.14-0.54,0.22-0.84	c0-0.01,0-0.03,0.01-0.05c0.85-3.03,2.74-7.63,9.76-8.54C21.45,27.81,22.81,27.95,24.05,28.3z"/><path fill="#fff" d="M36.88,18.02C34.52,19.82,28.71,22.98,18,25c1.78-1.11,6.13-2.22,9.71-4.93	C36.49,17,37.5,11.55,37.5,9.75C38.02,11.29,38.27,14.56,36.88,18.02z"/><path fill="#fff" d="M33.71,22.86c-1.61,0.98-4,2.08-8.1,2.86C25.1,25.82,24.56,25.91,24,26	c-4.02,0.62-7.66,1.81-10.32,4.64c-0.38,0.4-0.73,0.84-1.07,1.31C11.48,33.52,10.59,35.5,10,38c0-0.19,0-0.38,0.01-0.57	c0.14-4.17,1.91-8.96,7.32-12.26c1.57-0.96,3.44-1.79,5.67-2.44c0.94-0.28,1.93-0.52,3-0.73c4.93-0.97,7.77-2.79,9.39-4.76	c2.58-3.11,2.11-6.57,2.11-7.49C38.26,12.02,38.44,18.02,33.71,22.86z"/><path fill="#fff" d="M27.565,21.642C27.067,21.771,26.55,21.892,26,22c-1.07,0.21-2.06,0.45-3,0.73	c-2.23,0.65-4.1,1.48-5.67,2.44c-2.99,2.66-4.33,5.28-4.72,6.78c0.34-0.47,0.69-0.91,1.07-1.31c2.234-2.376,5.163-3.589,8.423-4.286	C23.793,25.34,26.079,23.77,27.565,21.642z"/><path fill="#fff" d="M23,22.73v0.02c-1.7,0.73-7.17,3.81-9.32,7.89C12.04,32.39,10.76,34.76,10,38	c0-0.19,0-0.38,0.01-0.57C10.19,32.05,13.08,25.64,23,22.73z"/>
                    </g>
                </g>
                <g class="group" transform="translate(200 98)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="-7" y="-3px">Symfony</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                ...
                <g class="group" transform="translate(170 388)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="-40" y="-3px">Visual Studio Code</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                    <g id="Visual" transform="scale(0.04) translate(90, 120)" >
                        <path d="m12.1 353.9s-24-17.3 4.8-40.4l67.1-60s19.2-20.2 39.5-2.6l619.2 468.8v224.8s-.3 35.3-45.6 31.4z" fill="#070302"/><path d="m171.7 498.8-159.6 145.1s-16.4 12.2 0 34l74.1 67.4s17.6 18.9 43.6-2.6l169.2-128.3z" fill="#070302"/><path d="m451.9 500 292.7-223.5-1.9-223.6s-12.5-48.8-54.2-23.4l-389.5 354.5z" fill="#070302"/><path d="m697.1 976.2c17 17.4 37.6 11.7 37.6 11.7l228.1-112.4c29.2-19.9 25.1-44.6 25.1-44.6v-671.2c0-29.5-30.2-39.7-30.2-39.7l-197.7-95.3c-43.2-26.7-71.5 4.8-71.5 4.8s36.4-26.2 54.2 23.4v887.5c0 6.1-1.3 12.1-3.9 17.5-5.2 10.5-16.5 20.3-43.6 16.2z" fill="#070302"/>
                    </g>
                </g>
                <g class="group" transform="translate(450 250)">
                    <text font-family="Bangers" font-size="10" font-weight="400" fill="black" x="-15" y="-3px">Wordpress</text>
                    <rect width="50" height="50" fill="#FFF" rx="25"/>
                    <g id="Wordpress" transform="scale(0.35) translate(10, 10)" >
                        <g fill="#070302"><path d="m8.708 61.26c0 20.802 12.089 38.779 29.619 47.298l-25.069-68.686c-2.916 6.536-4.55 13.769-4.55 21.388z"/><path d="m96.74 58.608c0-6.495-2.333-10.993-4.334-14.494-2.664-4.329-5.161-7.995-5.161-12.324 0-4.831 3.664-9.328 8.825-9.328.233 0 .454.029.681.042-9.35-8.566-21.807-13.796-35.489-13.796-18.36 0-34.513 9.42-43.91 23.688 1.233.037 2.395.063 3.382.063 5.497 0 14.006-.667 14.006-.667 2.833-.167 3.167 3.994.337 4.329 0 0-2.847.335-6.015.501l19.138 56.925 11.501-34.493-8.188-22.434c-2.83-.166-5.511-.501-5.511-.501-2.832-.166-2.5-4.496.332-4.329 0 0 8.679.667 13.843.667 5.496 0 14.006-.667 14.006-.667 2.835-.167 3.168 3.994.337 4.329 0 0-2.853.335-6.015.501l18.992 56.494 5.242-17.517c2.272-7.269 4.001-12.49 4.001-16.989z"/><path d="m62.184 65.857-15.768 45.819c4.708 1.384 9.687 2.141 14.846 2.141 6.12 0 11.989-1.058 17.452-2.979-.141-.225-.269-.464-.374-.724z"/><path d="m107.376 36.046c.226 1.674.354 3.471.354 5.404 0 5.333-.996 11.328-3.996 18.824l-16.053 46.413c15.624-9.111 26.133-26.038 26.133-45.426.001-9.137-2.333-17.729-6.438-25.215z"/><path d="m61.262 0c-33.779 0-61.262 27.481-61.262 61.26 0 33.783 27.483 61.263 61.262 61.263 33.778 0 61.265-27.48 61.265-61.263-.001-33.779-27.487-61.26-61.265-61.26zm0 119.715c-32.23 0-58.453-26.223-58.453-58.455 0-32.23 26.222-58.451 58.453-58.451 32.229 0 58.45 26.221 58.45 58.451 0 32.232-26.221 58.455-58.45 58.455z"/></g>
                    </g>
                </g>
...
export default {
  name: "SkillsWheel",
  mounted(){
      TweenMax.to("#master", 40, {rotation:360, svgOrigin:"326 326", ease:Linear.easeNone, repeat:-1});
      TweenMax.to("#master > g.group", 40, {rotation:-360, transformOrigin:"center center", ease:Linear.easeNone, repeat:-1});
    ...
    for(var i=0; i<groups.length;i++){
        ...
        groups[i].querySelector('rect').style.filter = 'hue-rotate('+random+'deg)'
    }
